...
def verify_limbach_results(lab_results, cfg):
    ...
    for lab_result in lab_results:
        ...
        # append lab result to matched or mismatched list and add additional information in case of mismatch
        if patient_mismatch_reason == None and parameter_mismatch_reason == None and lab_result["number_of_pages"] == "1":
            ...
            mismatched_lab_results[len(mismatched_lab_results) -
                                   1]["patient_mismatch_reason"] = patient_mismatch_reason
            mismatched_lab_results[len(mismatched_lab_results) -
                                   1]["parameter_mismatch_reason"] = parameter_mismatch_reason
        i += 1
    ...
    with open("mismatched_lab_results.csv", 'w', newline='') as outfile:
        fieldnames = ['page', 'anr', 'firstname', 'surname', 'birthday',
                      'parameter_mismatch_reason', 'patient_mismatch_reason', 'number_of_pages']
...
def verify_parameters(lab_result, cu, cfg):
    ...
    for parameter in lab_result["parameters"]:
        ...
        parameter_attributes["reference_range"] = cfg["parameters"][parameter["parameter"]
                                                                    ]["reference_range"]
        ...
        if "comment" in parameter:
            ...
            if result['success'] == True:
                # this ends up in the matched_lab_results.json file!
